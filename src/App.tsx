    ...
    <div className="page">
      ...
      <main>
        ...
        <section id="home" className="hero">
          <div className="container hero-content" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "2.5rem", flexWrap: "wrap" }}>
            
            {/* Profile Picture (Forced to Top/Left on Desktop, and Top on Mobile) */}
            <div style={{ flexShrink: 0, textAlign: "center" }}>
              <div style={{ width: "160px", height: "160px", borderRadius: "50%", overflow: "hidden", border: "4px solid #e2e8f0", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.1)" }}>
                <img 
                  src="/Profile.jpg" 
                  alt="Godfred Mensah" 
        ...
        <section id="leadership" className="section">
          <div className="container">
            ...
            <h2>Leadership, collaboration and service</h2>

            <div className="cards two-cards">
              <article className="card">
                <p className="card-label">Research Leadership</p>
          ...
          <div className="container">
            ...
            <div className="skills-grid">
              <div className="skill-group">
                ...
                <p>Power BI · Tableau · SQL/MySQL · SPSS · Advanced Excel</p>
              </div>
